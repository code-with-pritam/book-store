    ...
    <div className="px-4 lg:px-24 my-20 flex flex-col md:flex-row justify-between items-center">
      ...
      <div className="md:w-1/2 space-y-6">
        <h2 className="text-5xl font-bold my-5 md:w-3/4 leading-snug">
          Find Four Favorite <span className="text-blue-700">Book Here!</span>
        </h2>
        <p className="mb-10 text-lg md:5/6">
          Lorem ipsum dolor sit, amet consectetur adipisicing elit. Repellendus
          possimus, vero ratione aperiam ducimus voluptatum vel, architecto
          tempora, maiores nostrum commodi quidem iure provident alias dolore
          facere rerum suscipit animi?
        </p>
        {/* stats */}
